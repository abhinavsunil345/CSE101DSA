...
ListElement front(List a); // Returns front element of L. Pre: length()>0
ListElement back(List a); // Returns back element of L. Pre: length()>0
ListElement get(List a); // Returns cursor element of L. Pre: length()>0, index()>=0
...
void set(List a, ListElement x); // Overwrites the cursor element’s data with x.
...
void prepend(List a, ListElement x); // Insert new element into L. If L is non-empty,
 // insertion takes place before front element.
void append(List a, ListElement x); // Insert new element into L. If L is non-empty,
 // insertion takes place after back element.
void insertBefore(List a, ListElement x); // Insert new element before cursor.
 // Pre: length()>0, index()>=0
void insertAfter(List a, ListElement x); // Insert new element after cursor.
 // Pre: length()>0, index()>=0
